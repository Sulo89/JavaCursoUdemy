...
public class I_EjemploArreglosDetectarOrden {
    public static void main(String[] args) {
        ...
        //banderas para cambiar el valor cuando correspona
        boolean ascendente = false;
        boolean descendente = false;
        for(int i = 0; i < a.length - 1; i++){//-1 para que no se desborde con a[i+1]
