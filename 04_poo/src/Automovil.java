public class Automovil implements Comparable<Automovil>{
    ...
    private Color color = Color.GRIS;//asignamos el valor por defecto a los coches con el enum
    private Motor motor;
    ...
    public Automovil() {
        this.id = ++ultimoId;
        this.ruedas = new Rueda[5];//debemos crear el array en el constructor para poder añadir objetos Rueda a la lista con el método add
    }
    ...
    public Automovil addRueda(Rueda rueda){
        ...
        return this;//devolvemos el objeto para encadenar los métodos add
    }
    ...
    /*
       ...
       public int compareTo(Object o) {
           ...
           MEJOR USAMOS GENERIC <Automovil>
           y nos ahorramos el cast
       }
       */
    @Override
